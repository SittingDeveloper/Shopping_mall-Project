...
class OrderServiceTest {
    ...
    public void order() {
        ...
        orderDto.setCount(10); // 주문할 상품 개수
        ...
        assertEquals(totalPrice, order.getTotalPrice()); // 주문한 상품의 총 가격과 데이터베이스에 저장된 상품의 가격을 비교하여 테스트가 성공적으로 종료

    }

    // 주문 취소 로직이 제대로 동작하는지 확인하는 테스트 코드
    @Test
    @DisplayName("주문 취소 테스트")
    public void cancelOrder() {

        // 테스트를 위해서 상품과 회원 데이터를 생성, 생성한 상품의 재고는 100개
        Item item = saveItem();
        Member member = saveMember();
